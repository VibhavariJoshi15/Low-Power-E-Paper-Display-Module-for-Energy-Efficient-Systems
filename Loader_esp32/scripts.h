...
//client.println(
//        "// ================= Global Variables =================\r\n"
//        "var srcBox, srcImg, epdArr, epdInd, palArr, curPal;\r\n"
//        "var epdArr,epdInd,palArr;\r\n"
//        "var curPal;\r\n"
//        "var selectedDeviceIP='';\r\n"
...
//"}\r\n"
////        "var devices=[\r\n"
////        "    {name:'Screen 1', ip:'192.168.1.100'},\r\n"
////        "    {name:'Screen 2', ip:'192.168.1.101'},\r\n"
////        "    {name:'Screen 3', ip:'192.168.1.102'}\r\n"
////        "];\r\n"
//        "\r\n"
//        "// ================= Utility Functions =================\r\n"
////        "function getElm(id){return document.getElementById(id);}\r\n"
////        "function setInn(id, html){getElm(id).innerHTML=html;}\r\n"
//
//   
//        "\r\n"
//        "// ================= Landing & Login =================\r\n"
...
//        "    getElm(pageId).classList.remove('hidden');\r\n"
//        "    window.scrollTo(0,0);\r\n"
//        "}\r\n"
...
//"    const loginBtn = getElm('loginBtn');\r\n"
//"    if(loginBtn){\r\n"
//"        loginBtn.addEventListener('click', ()=>{\r\n"
//"            const user = getElm('username').value.trim().toLowerCase();\r\n"
//"            const pass = getElm('password').value.trim();\r\n"
//"            if(user==='operator'){\r\n"
//"                showPage('uploadPage');\r\n"
//"                initUploadUI();\r\n"
//"            } else if(user==='admin'){\r\n"
...
//        "    setInn('RB',renderRadioButtons());\r\n"
//        "}\r\n"
//        "// ================= Device Modal =================\r\n"
//        "getElm('chooseDeviceBtn').addEventListener('click',()=>{\r\n"
//        "    const modal=getElm('deviceModal');\r\n"
//        "    const list=getElm('deviceList');\r\n"
//        "    list.innerHTML='';\r\n"
//        "    devices.forEach((d,i)=>{\r\n"
//        "        const div=document.createElement('div');\r\n"
//        "        div.className='device-card';\r\n"
//        "        div.innerHTML=`<span>${d.name} - ${d.ip}</span><div><button class='btn' onclick='selectDevice('${d.ip}')'>Choose</button><button class='btn' onclick='removeDevice(${i})'>Remove</button></div>`;\r\n"
//        "        list.appendChild(div);\r\n"
//        "    });\r\n"
//        "    modal.classList.remove('hidden');\r\n"
//        "});\r\n"
//        "getElm('closeModal').addEventListener('click',()=>{ getElm('deviceModal').classList.add('hidden'); });\r\n"
//        "function selectDevice(ip){ selectedDeviceIP=ip; getElm('deviceModal').classList.add('hidden'); }\r\n"
//        "function removeDevice(idx){ devices.splice(idx,1); getElm('chooseDeviceBtn').click(); }\r\n"
//        "// ================= Admin Dashboard =================\r\n"
//        "function renderAdminDevices(){\r\n"
//        "    const grid=getElm('deviceGrid');\r\n"
//        "    grid.innerHTML='';\r\n"
//        "    devices.forEach(d=>{\r\n"
//        "        const card=document.createElement('div');\r\n"
//        "        card.className='device-card';\r\n"
//        "        card.innerHTML=`<h4>${d.name}</h4><p>${d.ip}</p><img src='placeholder.png' alt='Last Image'><p>Last Update: ${new Date().toLocaleString()}</p>`;\r\n"
